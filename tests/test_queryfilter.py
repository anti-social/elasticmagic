...
def test_grouped_page_filter(index, client):
    class CarQueryFilter(QueryFilter):
    ...
    assert qf_res.page.total == 6
    assert qf_res.page.page == 2
    assert qf_res.page.pages == 2
    assert qf_res.page.has_next is False
    assert qf_res.page.has_prev is True
    assert qf_res.page.items is None
